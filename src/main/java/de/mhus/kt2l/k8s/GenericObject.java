...
public class GenericObject implements KubernetesObject {
    ...
    public GenericObject(Map<String, Object> data) {
        ...
        metatdata.setCreationTimestamp(OffsetDateTime.parse((String)data.get("creationTimestamp")));
        metatdata.setDeletionTimestamp(OffsetDateTime.parse((String)data.get("deletionTimestamp")));
