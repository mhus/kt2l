...
public abstract class K8sV1NetworkPolicy implements HandlerK8s {
    ...
    public KubernetesObject get(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        return apiProvider.getNetworkingV1Api().readNamespacedNetworkPolicy(
            name
            ,namespace
        ).execute();
    }
    ...
    public Object replace(ApiProvider apiProvider, String name, String namespace, String yaml) throws ApiException {
        var res = Yaml.loadAs(yaml, V1NetworkPolicy.class);
        return replaceResource(apiProvider, name, namespace, res);
    }

    public Object replaceResource(ApiProvider apiProvider, String name, String namespace, V1NetworkPolicy resource) throws ApiException {
    ...
    public V1NetworkPolicyList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getNetworkingV1Api().listNetworkPolicyForAllNamespaces().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getNetworkingV1Api().listNetworkPolicyForAllNamespaces().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            ...
            () -> apiProvider.getNetworkingV1Api().patchNamespacedNetworkPolicy(
                    name,
                    namespace,
                    patch
            ).buildCall(new CallBackAdapter<V1NetworkPolicy>(LOGGER)),
