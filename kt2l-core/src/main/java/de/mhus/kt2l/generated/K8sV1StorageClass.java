...
public abstract class K8sV1StorageClass implements HandlerK8s {
    ...
    public KubernetesObject get(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        return apiProvider.getStorageV1Api().readStorageClass(
            name
        ).execute();
    }
    ...
    public Object replace(ApiProvider apiProvider, String name, String namespace, String yaml) throws ApiException {
        var res = Yaml.loadAs(yaml, V1StorageClass.class);
        return replaceResource(apiProvider, name, namespace, res);
    }

    public Object replaceResource(ApiProvider apiProvider, String name, String namespace, V1StorageClass resource) throws ApiException {
    ...
    public V1StorageClassList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getStorageV1Api().listStorageClass().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getStorageV1Api().listStorageClass().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            ...
            () -> apiProvider.getStorageV1Api().patchStorageClass(
                    name,
                    patch
            ).buildCall(new CallBackAdapter<V1StorageClass>(LOGGER)),
