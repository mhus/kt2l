...
public abstract class K8sV1PersistentVolume implements HandlerK8s {
    ...
    public KubernetesObject get(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        return apiProvider.getCoreV1Api().readPersistentVolume(
            name
        ).execute();
    }
    ...
    public V1PersistentVolumeList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listPersistentVolume().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listPersistentVolume().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            ...
            () -> apiProvider.getCoreV1Api().patchPersistentVolume(
                    name,
                    patch
            ).buildCall(new CallBackAdapter<V1PersistentVolume>(LOGGER)),
