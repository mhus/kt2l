...
public abstract class K8sV1ConfigMap implements HandlerK8s {
    ...
    public V1ConfigMapList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listConfigMapForAllNamespaces(
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listConfigMapForAllNamespacesCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return apiProvider.getCoreV1Api().patchNamespacedConfigMapCall(
            name,
            namespace,
            patch,
            null, null, null, null, null, null
