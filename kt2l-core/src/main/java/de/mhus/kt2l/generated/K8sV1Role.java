...
public abstract class K8sV1Role implements HandlerK8s {
    ...
    public KubernetesObject get(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        return apiProvider.getRbacAuthorizationV1Api().readNamespacedRole(
            name
            ,namespace
        ).execute();
    }
    ...
    public V1RoleList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getRbacAuthorizationV1Api().listRoleForAllNamespaces().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getRbacAuthorizationV1Api().listRoleForAllNamespaces().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            V1Role.class,
            () -> apiProvider.getRbacAuthorizationV1Api().patchNamespacedRole(
                    name,
                    namespace,
                    patch
            ).buildCall(new CallBackAdapter<V1Role>(LOGGER)),
