...
public abstract class K8sV1ReplicaSet implements HandlerK8s {
    ...
    public V1ReplicaSetList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getAppsV1Api().listReplicaSetForAllNamespaces().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getAppsV1Api().listReplicaSetForAllNamespaces().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            V1ReplicaSet.class,
            () -> apiProvider.getAppsV1Api().patchNamespacedReplicaSet(
                    name,
                    namespace,
                    patch
            ).buildCall(new CallBackAdapter<V1ReplicaSet>(LOGGER)),
