...
public abstract class K8sV1DaemonSet implements HandlerK8s {
    ...
    public void replace(ApiProvider apiProvider, String name, String namespace, String yaml) throws ApiException {
        ...
        apiProvider.getAppsV1Api().replaceNamespacedDaemonSet(
            name,
            namespace,
            body,
            null, null, null, null
    ...
    public V1DaemonSetList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getAppsV1Api().listDaemonSetForAllNamespaces(
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getAppsV1Api().listDaemonSetForAllNamespacesCall(
