...
public abstract class K8sV1Namespace implements HandlerK8s {
    ...
    public KubernetesObject get(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        return apiProvider.getCoreV1Api().readNamespace(
            name
        ).execute();
    }
    ...
    public V1NamespaceList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listNamespace().execute();
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getCoreV1Api().listNamespace().watch(true).buildCall(
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
            V1Namespace.class,
            () -> apiProvider.getCoreV1Api().patchNamespace(
                    name,
                    patch
            ).buildCall(new CallBackAdapter<V1Namespace>(LOGGER)),
