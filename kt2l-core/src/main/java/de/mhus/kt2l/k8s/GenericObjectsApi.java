...
public class GenericObjectsApi {
    ...
    public GenericObjectsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public GenericObjectsApi(ApiClient apiClient) {
    ...
    public okhttp3.Call listNamespacedCustomObjectCall(
        ...
        if (group == null) {
            ...
            group = "/apis/" + localVarApiClient.escapeString(group.toString()) + "/";
        }

        if (namespace == null) {
            namespace = "";
        } else {
            namespace = "namespaces/" + localVarApiClient.escapeString(namespace.toString()) + "/";
        }
        ...
        System.out.println("localVarPath: " + localVarPath);
...
//        }
    ...
    public KubernetesObject toKubernetesObject(Map<String, Object> o, String group, String apiVersion, String plural) {
        return toKubernetesObject(o, K8s.toResourceType(group, apiVersion, plural));
    }
    public KubernetesObject toKubernetesObject(Map<String, Object> o, String resourceType) {

        List<V1APIResource> types = K8s.getResourceTypes(new CoreV1Api(getApiClient()));
        V1APIResource type = types.stream().filter(t -> K8s.toResourceType(t).equals(resourceType)).findFirst().orElse(null);
//        if (type == null)
