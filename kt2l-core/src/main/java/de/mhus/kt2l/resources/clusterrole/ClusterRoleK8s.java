...
@Slf4j
@Component
public class ClusterRoleK8s implements HandlerK8s {
    ...
    public V1Status delete(ApiProvider apiProvider, String name, String namespace) throws ApiException {
        ...
        return apiProvider.getRbacAuthorizationV1Api().deleteClusterRole(name, null, null, null, null, null, null );
    }
    ...
    public Object create(ApiProvider apiProvider, String yaml) throws ApiException {
        ...
        var body = Yaml.loadAs(yaml, V1ClusterRole.class);
        return apiProvider.getRbacAuthorizationV1Api().createClusterRole(body,null, null, null, null);
    }
    ...
    public Call createResourceWatchCall(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getRbacAuthorizationV1Api().listClusterRoleCall(null, null, null, null, null, null, null, null, null, null, true, new CallBackAdapter(LOGGER));
    }

    @Override
    public V1ClusterRoleList createResourceListWithoutNamespace(ApiProvider apiProvider) throws ApiException {
        return apiProvider.getRbacAuthorizationV1Api().listClusterRole(null, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    public Object patch(ApiProvider apiProvider, String namespace, String name, String patchString) throws ApiException {
        ...
        return PatchUtils.patch(
                V1ClusterRole.class,
                () -> apiProvider.getRbacAuthorizationV1Api().patchClusterRoleCall(
                        name,
                        patch,
                        null,
                        null,
