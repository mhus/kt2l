...
@Slf4j
public class PersistentVolumeWatch extends ClusterBackgroundJob {
    ...
    public static PersistentVolumeWatch instance(Core core, Cluster cluster) {
        return core.getBackgroundJob(cluster.getName(), PersistentVolumeWatch.class, () -> new PersistentVolumeWatch());
    }

    private PersistentVolumeWatch() {
    }
        ...
        while (true) {
            try {
                ...
                Watch<V1PersistentVolume> watch = Watch.createWatch(
                        ...
                        call,
                        new TypeToken<Watch.Response<V1PersistentVolume>>() {
                        }.getType());

                for (Watch.Response<V1PersistentVolume> event : watch) {
                    V1PersistentVolume res = event.object;
