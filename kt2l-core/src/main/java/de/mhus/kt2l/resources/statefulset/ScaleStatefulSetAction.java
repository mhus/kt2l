...
public class ScaleStatefulSetAction implements ResourceAction {
    ...
    public void execute(ExecutionContext context) {
        ...
        dialog.setHeaderTitle("Scale StatefulSet");
        IntegerField replicasField = new IntegerField();
        replicasField.setLabel("Replicas");
        replicasField.setMin(0);
        replicasField.setValue( ((V1StatefulSet)context.getSelected().stream().findFirst().get()).getSpec().getReplicas() );
    ...
    private void setReplicas(ExecutionContext context, Integer value) {
        ...
        progress.setHeaderTitle("Scale StatefulSet");
