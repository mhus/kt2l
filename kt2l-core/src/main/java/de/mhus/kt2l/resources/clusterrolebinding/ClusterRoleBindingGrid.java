...
@Slf4j
public class ClusterRoleBindingGrid extends AbstractGrid<ClusterRoleBindingGrid.Resource, Component> {
    ...
    @Override
    protected void init() {
        eventRegistration = ClusterRoleBindingWatch.instance(view.getCore(), view.getClusterConfig()).getEventHandler().registerWeak(this::changeEvent);
                            ...
                            Try.of(() -> createRawResourceList() )
                                    ...
                                    .onSuccess(list -> {
                                        list.getItems().forEach(res -> {
                                            ClusterRoleBindingGrid.this.resourcesList.add(new Resource(
    ...
    public static class Resource {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof V1ClusterRoleBinding res)
