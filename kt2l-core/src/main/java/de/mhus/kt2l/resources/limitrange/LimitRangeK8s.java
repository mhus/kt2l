...
@Component
public class LimitRangeK8s implements HandlerK8s {
    ...
    public void replace(CoreV1Api api, String name, String namespace, String yaml) throws ApiException {
        ...
        api.replaceNamespacedLimitRange(
                name, namespace,
                body
        ).execute();
    }
    ...
    public V1Status delete(CoreV1Api api, String name, String namespace) throws ApiException {
        checkDeleteAccess(securityService, K8s.RESOURCE.LIMIT_RANGE);
        return api.deleteNamespacedLimitRange(name, namespace).execute();
    }
