...
@Slf4j
public class CronJobWatch extends ClusterBackgroundJob {

    @Autowired
    K8sService k8s;

    @Getter
    private MEventHandler<Watch.Response<V1CronJob>> eventHandler = new MEventHandler<>();
    ...
    private void watch() {
        ...
        while (true) {
            try {
                ...
                for (Watch.Response<V1CronJob> event : watch) {
                    V1CronJob res = event.object;
