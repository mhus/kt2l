...
@Slf4j
public class RoleWatch extends ClusterBackgroundJob {
    ...
    public static RoleWatch instance(Core core, Cluster cluster) {
        return core.getBackgroundJob(cluster.getName(), RoleWatch.class, () -> new RoleWatch());
    }
        ...
        while (true) {
            try {
                ...
                Watch<V1Role> watch = Watch.createWatch(
                        ...
                        call,
                        new TypeToken<Watch.Response<V1Role>>() {
                        }.getType());

                for (Watch.Response<V1Role> event : watch) {
                    V1Role res = event.object;
