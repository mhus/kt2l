...
@Slf4j
public class DaemonSetWatch extends ClusterBackgroundJob {

    @Autowired
    K8sService k8s;

    @Getter
    private MEventHandler<Watch.Response<V1DaemonSet>> eventHandler = new MEventHandler<>();
    private Thread watchThread;
    private String clusterId;

    public static DaemonSetWatch instance(Core core, Cluster cluster) {
        return core.getBackgroundJob(cluster.getName(), DaemonSetWatch.class, () -> new DaemonSetWatch());
    }
