...
public class HorizontalPodAutoscalerGridFactory implements ResourceGridFactory {
    @Override
    public boolean canHandleResourceType(K8s.RESOURCE resourceType) {
        return K8s.RESOURCE.HPA.equals(resourceType);
    }

    @Override
    public ResourcesGrid create(K8s.RESOURCE resourcesType) {
        return new HorizontalPodAutoscalerGrid();
    }
}
