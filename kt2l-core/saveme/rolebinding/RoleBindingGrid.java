...
public class RoleBindingGrid extends AbstractGrid<RoleBindingGrid.Resource, Component> {
    ...
    public K8s.RESOURCE getManagedResourceType() {
        return K8s.RESOURCE.ROLE_BINDING;
    }
                            ...
                            MLang.tryThis(() -> createRawResourceList() )
                                    ...
                                    .onSuccess(list -> {
                                        list.getItems().forEach(res -> {
                                            RoleBindingGrid.this.resourcesList.add(new Resource(res));
                                        });
                                    });
                        }
                        filterList();
    ...
    public static class Resource {
        ...
        String namespace;
        long created;
        V1RoleBinding resource;

        public Resource(V1RoleBinding resource) {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof V1RoleBinding res)
