...
@Slf4j
public class ServiceAccountGrid extends AbstractGrid<ServiceAccountGrid.Resource, Component> {
                            ...
                            MLang.tryThis(() -> createRawResourceList() )
                                    ...
                                    .onSuccess(list -> {
                                        list.getItems().forEach(res -> {
                                            ServiceAccountGrid.this.resourcesList.add(new Resource(res));
                                        });
                                    });
                        }
                        filterList();
    ...
    public static class Resource {
        ...
        String namespace;
        long created;
        V1ServiceAccount resource;

        public Resource(V1ServiceAccount resource) {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof V1ServiceAccount res)
